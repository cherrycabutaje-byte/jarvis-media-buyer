...
"    }",
"    const lang = language;",
"    const li = \"LANGUAGE REQUIREMENT - THIS IS MANDATORY: Your response MUST be written entirely in \" + lang + \". This is not optional. Do not write in English unless \" + lang + \" is English. Do not mix languages. Every single word including headings, labels, and analysis must be in \" + lang + \". If you write in any other language you have failed. Write as a native \" + lang + \" speaker would naturally speak.\";",
