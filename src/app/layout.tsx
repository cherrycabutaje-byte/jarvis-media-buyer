  ...
  return (
    <html lang="en">
      ...
      <body style={{ fontFamily: "'Noto Sans', 'Noto Sans JP', 'Noto Sans SC', 'Noto Sans Arabic', Arial, sans-serif" }}>
        {children}
            <a href="https://wa.me/306973229580" target="_blank" rel="noopener noreferrer" style={{position: "fixed", bottom: "24px", right: "24px", width: "56px", height: "56px", borderRadius: "50%", background: "#25d366", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 12px rgba(0,0,0,0.3)", zIndex: 1000, textDecoration: "none"}}>
